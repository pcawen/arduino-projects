...
const char* ssid = "loupablo_2.4GHz";
const char* password = "p4bl0lul1";
...
void loop(){
  ...
  //Reding GPIO0 with debouncing
  int switchReading = digitalRead(lightSwitch);
  ...
  if ((millis() - lastDebounceTime) > debounceDelay) {
    if (switchReading != switchState) {
      ...
      client.publish("/test/confirm", "Light toggled");
    }
  }
